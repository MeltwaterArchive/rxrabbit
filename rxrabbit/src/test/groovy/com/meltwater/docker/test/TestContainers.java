...
public class TestContainers {
    ...
    public TestContainers(String composeFile, Class<?> testClass) {
        ...
        this.rabbitHandler = new RabbitHandler(compose, inspectDataCache, "rabbit");
    }

    public TestContainers(Class<?> testClass) {
    ...
    public RabbitHandler rabbit() {
        return rabbitHandler;
    }

    public RabbitHandler rabbit(String containerName) {
        return new RabbitHandler(compose, inspectDataCache, containerName);
    }
}
